...
type EmployeeFormDefaults = Pick<NewEmployee, 'id' | 'cars'>;
...
type EmployeeFormGroupContent = {
  ...
  birthLocation: FormControl<IEmployee['birthLocation']>;
  ...
  cars: FormControl<IEmployee['cars']>;
};
...
export class EmployeeFormService {
  createEmployeeFormGroup(employee: EmployeeFormGroupInput = { id: null }): EmployeeFormGroup {
    ...
    return new FormGroup<EmployeeFormGroupContent>({
      ...
      birthLocation: new FormControl(employeeRawValue.birthLocation),
      ...
      cars: new FormControl(employeeRawValue.cars ?? []),
    });
  }
