...
import com.jhipster.employee.repository.CarRepository;
import com.jhipster.employee.service.criteria.CarCriteria;
import com.jhipster.employee.service.dto.CarDTO;
import com.jhipster.employee.service.mapper.CarMapper;
...
class CarResourceIT {
    ...
    public static Car createEntity(EntityManager em) {
        Car car = new Car().name(DEFAULT_NAME).brand(DEFAULT_BRAND).price(DEFAULT_PRICE);
        return car;
    }
    ...
    public static Car createUpdatedEntity(EntityManager em) {
        Car car = new Car().name(UPDATED_NAME).brand(UPDATED_BRAND).price(UPDATED_PRICE);
        return car;
    }
    ...
    void getAllCarsByBrandIsEqualToSomething() throws Exception {
        ...
        // Get all the carList where brand equals to DEFAULT_BRAND
        defaultCarShouldBeFound("brand.equals=" + DEFAULT_BRAND);

        // Get all the carList where brand equals to UPDATED_BRAND
        defaultCarShouldNotBeFound("brand.equals=" + UPDATED_BRAND);
    }
    ...
    void getAllCarsByBrandIsInShouldWork() throws Exception {
        ...
        // Get all the carList where brand in DEFAULT_BRAND or UPDATED_BRAND
        defaultCarShouldBeFound("brand.in=" + DEFAULT_BRAND + "," + UPDATED_BRAND);

        // Get all the carList where brand equals to UPDATED_BRAND
        defaultCarShouldNotBeFound("brand.in=" + UPDATED_BRAND);
    }
    ...
    void getAllCarsByBrandIsNullOrNotNull() throws Exception {
        ...
        defaultCarShouldBeFound("brand.specified=true");

        // Get all the carList where brand is null
        defaultCarShouldNotBeFound("brand.specified=false");
    }
    ...
    void getAllCarsByBrandContainsSomething() throws Exception {
        ...
        // Get all the carList where brand contains DEFAULT_BRAND
        defaultCarShouldBeFound("brand.contains=" + DEFAULT_BRAND);

        // Get all the carList where brand contains UPDATED_BRAND
        defaultCarShouldNotBeFound("brand.contains=" + UPDATED_BRAND);
    }
    ...
    void getAllCarsByBrandNotContainsSomething() throws Exception {
        ...
        // Get all the carList where brand does not contain DEFAULT_BRAND
        defaultCarShouldNotBeFound("brand.doesNotContain=" + DEFAULT_BRAND);

        // Get all the carList where brand does not contain UPDATED_BRAND
        defaultCarShouldBeFound("brand.doesNotContain=" + UPDATED_BRAND);
    }
    ...
    void putExistingCar() throws Exception {
        ...
        updatedCar.name(UPDATED_NAME).brand(UPDATED_BRAND).price(UPDATED_PRICE);
    ...
    void partialUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.name(UPDATED_NAME).brand(UPDATED_BRAND).price(UPDATED_PRICE);
